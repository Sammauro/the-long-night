...
export const DEMO_LEVEL = {
  ...
  enemies: [
    { id: 'zombie_a', type: 'zombie', pos: { r: 1, q: 2 } },
    { id: 'zombie_b', type: 'zombie', pos: { r: 2, q: 6 } },
    { id: 'zombie_c', type: 'zombie', pos: { r: 7, q: 1 } },
    { id: 'zombie_d', type: 'zombie', pos: { r: 8, q: 5 } },
  ],

  // Ostacoli inamovibili — colonne
  obstacles: [
    { id: 'col_a', type: 'column', pos: { r: 4, q: 1 } },
    { id: 'col_b', type: 'column', pos: { r: 5, q: 6 } },
  ],

  // Trappole — danni a chi ci entra
  traps: [
    { id: 'trap_a', pos: { r: 6, q: 4 }, active: true },
  ],
};
